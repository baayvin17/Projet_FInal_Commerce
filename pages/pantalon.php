...
<nav class="navbar navbar-expand-lg navbar-light bg-light">
    ...
    <h2 class="text-center mt-4">Les Pantalons</h2>
        ...
        while ($row = $result->fetch_assoc()) {
            ...
            if (isset($user_id)) {
                ...
                if ($user['statut'] == 'actif') {
                    echo '<a href="ajouter_panier_pantalon.php?id=' . $row['id_pantalon'] . '&user_id=' . $user_id . '" class="mx-4 btn btn-success">Ajouter au Panier</a>';
                    echo '<a href="ajouter_wish_pantalon.php?id=' . $row['id_pantalon'] . '&user_id=' . $user_id . '" class="btn btn-info">Ajouter a la wishlist</a>';
                } else {
